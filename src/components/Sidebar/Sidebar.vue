...
let onClickSidebarCollapse = ($event) => {
    ...
    let sidebarNav = el.closest('.sidebar--nav-item');
    ...
    <div class="sidebar">
      ...
      <div class="sidebar--nav">
        ...
        <a class="sidebar--nav-item">
          ...
          <SidebarPopup>
            <a href="/database/songs">Songs</a>
            <a href="/database/albums">Albums</a>
            <a href="/database/artists">Artists</a>
          </SidebarPopup>
        </a>
...
header {
  .sidebar {
    ...
    border: 2px solid rgba(var(--color-rose));
    border-radius: 4px;
    ...
    .sidebar--nav {
      ...
      .sidebar--nav-item {
        ...
        &:hover {
          ...
          /* Needs to be here, because .sidebar--nav needs to be registered */
          .sidebar-popup {
            visibility: visible;
            opacity: 1;
          }
